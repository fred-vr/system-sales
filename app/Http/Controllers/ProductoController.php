...
class ProductoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $array = array($request->idcategoria,'-', $request->codigo,'-', $request->nombre,'-', $request->precio_venta,'-', $request->stock,'-', 1);
    ...
    public function update(Request $request)
    {
        ...
        $array = array($request->idcategoria,'-', $request->codigo,'-', $request->nombre,'-', $request->precio_venta,'-', $request->stock,'-', 1, '-',date('Y-m-d H:i:s'));
