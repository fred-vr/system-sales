...
class CompraController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $array= array($request->idproveedor,'-', $request->tipo_identificacion,'-', $request->num_compra,'-', $mytime->toDateString(),'-', $request->impuesto,'-', $request->total,'-', 'Registrado', date('Y-m-d H:i:s'));
